...
export function Head() {
  return (
    <>
      <Meta siteTitle="Chiha Constitutional Papers" />
      <Stylesheet />
      ...
      />
      <link
        href="https://fonts.googleapis.com/css2?family=Cormorant+Garamond:ital,wght@0,300..700;1,300..700&family=Open+Sans:ital,wght@0,300..800;1,300..800&display=swap"
        rel="stylesheet"
      />
      <link
      ...
      />
      <link
        href="https://fonts.googleapis.com/css2?family=Funnel+Sans:ital@0;1&display=swap"
        rel="stylesheet"
      />
    </>
  );
  ...
  return (
    <>
      <CanopyHeader
        ...
        title="Michel Chiha's Constitutional Papers"
        logo={Logo}
      />
      <main>{children}</main>
      <CanopyFooter>
        <p>Copyright 2025 Michel Chiha Foundation, MIT License. A Canopy IIIF Project.</p>
      </CanopyFooter>
    </>
  );
}
